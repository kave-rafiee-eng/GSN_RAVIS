...
//-------------------------------------------------CALIBRATION_DIR		6   STNG
list($id,$direction,$change) = post_register_manager($con,"direction",$serial,"advance_settin","general*calibreation*",0,6);

//-------------------------------------------------CALIBRATION_SPEED	7  STNG
list($id,$speed,$change) = post_register_manager($con,"speed",$serial,"advance_settin","general*calibreation*",0,7);


//-------------------------------------------------CLEAR $POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    header("location: /GSM_RAVIS/main/ADVANCE/GENERAL/CALIBRATION/calibration.php");
}
    ...
    * License: https://bootstrapmade.com/license/
    ...
    <SCRIPT>
        ...
        function refresh(){
            ...
            xhttp.open("GET", "calibration_ajax.php?"+str, true);
            xhttp.send();
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"> <!--  Speed !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6 ">
                                                <select  style="color: #0a53be" id="speed" name='speed' class="form-select ">
                                                    <?php
                                                    show_list($List_speed,$speed);
                                                    ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <li class="list-group-item"> <!--  Direction !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6 ">
                                                <select  style="color: #0a53be" id="direction" name='direction' class="form-select ">
                                                    <?php
                                                    show_list($List_direction,$direction);
                                                    ?>
                                                </select>
                                            </div>
                                        </div>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">تنظیمات شناسایی</div>
                                </div>
                            </div>
...
<script  src="calibration.js?v1"></script>
