    ...
    * License: https://bootstrapmade.com/license/
    ...
    <SCRIPT>
        ...
        function refresh(){
            ...
            xhttp.open("GET", "hydrolic_ajax.php?"+str, true);
            xhttp.send();
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><!--  START SLOW DELAY !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="0.1" value="<?php echo $start_slow_delay;?>" name="start_slow_delay" id="start_slow_delay" type="number" class="form-control"  min="0" max="20">
                                            </div>
                                    ...
                                    <li class="list-group-item"><!--  START FAST DELAY !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="0.1" value="<?php echo $start_fast_delay;?>" name="start_fast_delay" id="start_fast_delay" type="number" class="form-control"  min="0" max="20">
                                            </div>
                                            <label class="col-sm-2 col-form-label text-danger ">sec</label>
                                        </div>
                                    </li>
                                    ...
                                    <li class="list-group-item"><!--  START TO DELTA !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="0.1" value="<?php echo $start_to_delta;?>" name="start_to_delta" id="start_to_delta" type="number" class="form-control"  min="0" max="20">
                                            </div>
                                            <label class="col-sm-2 col-form-label text-danger ">sec</label>
                                        </div>
                                    </li>
                                    ...
                                    <li class="list-group-item"><!--  MOTOR START DELAY !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="0.1" value="<?php echo $motor_start_delay;?>" name="motor_start_delay" id="motor_start_delay" type="number" class="form-control"  min="0" max="10">
                                            </div>
                                            <label class="col-sm-2 col-form-label text-danger ">sec</label>
                                        </div>
                                    </li>
                                    ...
                                    <li class="list-group-item"><!--  MOTOR STOP DELAY !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="0.1" value="<?php echo $motor_stop_delay;?>" name="motor_stop_delay" id="motor_stop_delay" type="number" class="form-control"  min="-10" max="10">
                                            </div>
                                            <label class="col-sm-2 col-form-label text-danger ">sec</label>
                                        </div>
                                    </li>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">تنظیمات مربوط به هیدرولیک</div>
                                </div>
                            </div>
...
<script  src="hydrolic.js?v1"></script>
