...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    header("location: /GSM_RAVIS/main/ADVANCE/GENERAL/LANDING/level_distanance.php");
}
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Based On</li>
                <li class="breadcrumb-item active">Level Distanance</li>
            </ol>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="card"  >
                    <div class="card-body ">
                        <h5 class="card-title">Jump1 Speed</h5>
                            ...
                            <div class="row mb-3 m-2" >
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><!--  Open Delay !-->
                                        <div class="row ">
                                            <label class="col-sm-4 col-form-label">Jump1 Speed</label>
                                            <table  class="table datatable text-center  ">
                                                ...
                                                for($i_floor=1;$i_floor<=$number_of_stop;$i_floor++ ){
                                                    ...
                                                    $temp = $i_floor-1;
                                                    echo "<th class=\"table-active\" scope=\"row\">"."$temp"."</th>";
                                                    ...
                                                    list($id,$data,$ch) =only_read_data($con,$serial,"advance_settin","general*landing*based_on*distance*f$i_floor");
                                                    $data /= 10;
                                                    echo "<input  step='0.1' value='$data' name='distance*f$i_floor' id='distance*f$i_floor' type='number' class='form-control'  min='0' max='20'>";
                                                    echo '</div>';

                                                    echo "<div class='col-sm-3' >";
                                                    echo "<label class='  text-danger '>m/s</label>";
                                                    echo '</div>';

                                                    echo '</div>';


                                                    /*echo "<select  id=\"select\" name='jump1speed*f$i_floor' class=\"form-select\" >";
                                                    list($id,$data,$ch) = only_read_data($con,$serial,"advance_settin","general*landing*based_on*jump1speed*f$i_floor");
                                                    show_list($List_speed,$data);
                                                    echo "</select>" ;*/
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">فاصله طبقات بر حسب متر</div>
                                </div>
                            </div>
...
<script  src="level_distance.js?v1"></script>
