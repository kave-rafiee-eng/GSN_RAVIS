...
//-------------------------------------------------ACCELERATION     STNG    55
list($id,$acceleration,$change) = post_register_manager($con,"acceleration",$serial,"advance_settin","general*landing*based_on*",0,55,10);


//-------------------------------------------------CLEAR $POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    header("location: /GSM_RAVIS/main/ADVANCE/GENERAL/LANDING/acceleration.php");
}
    ...
    <SCRIPT>
       ...
       /* var on_load=0;
        ...
        function refresh(){
            ...
            xhttp.open("GET", "acceleration_ajax.php?"+str, true);
            xhttp.send();
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Acceleration</li>
            </ol>
                            ...
                            <div class="row mb-3 m-2" >
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><!--  Delay !-->
                                        <div class="row ">
                                            <label class="col-sm-4 col-form-label">Acceleration</label>
                                            <div class="col-sm-6">
                                                <input  step="0.1" value="<?php echo $acceleration?>" name="acceleration" id="acceleration" type="number" class="form-control"  min="0" max="10">
                                            </div>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">شتاب مثبت ابتدای حرکت موتو ربر اساس متر بر ثانیه</div>
                                </div>
                            </div>
...
<script  src="acceleration.js?v1"></script>
