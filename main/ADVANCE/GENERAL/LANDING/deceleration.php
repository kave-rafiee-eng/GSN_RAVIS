...
//-------------------------------------------------DECCELERATION    STNG    56
list($id,$decceleration,$change) = post_register_manager($con,"decceleration",$serial,"advance_settin","general*landing*based_on*",0,56,10);

//-------------------------------------------------CLEAR $POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    header("location: /GSM_RAVIS/main/ADVANCE/GENERAL/LANDING/deceleration.php");
}
    ...
    * License: https://bootstrapmade.com/license/
    ...
    <SCRIPT>
        ...
        function refresh(){
            ...
            xhttp.open("GET", "deceleration_ajax.php?"+str, true);
            xhttp.send();
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Decceleration</li>
            </ol>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="card"  >
                    <div class="card-body ">
                        <h5 class="card-title">Decceleration</h5>
                        ...
                        <!-- <form method="post" action="" > -->
                            ...
                            <div class="row mb-3 m-2" >
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><!--  Delay !-->
                                        <div class="row ">
                                            <label class="col-sm-4 col-form-label">Decceleration</label>
                                            <div class="col-sm-6">
                                                <input  step="0.1" value="<?php echo $decceleration?>" name="decceleration" id="decceleration" type="number" class="form-control"  min="0" max="20">
                                            </div>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">شتاب منفی انتهای حرکت موتور بر حسب متر بر ثانیه</div>
                                </div>
                            </div>
...
<script  src="decceleration.js?v1"></script>
