...
//-------------------------------------------------MOTOR_SPEED		STNG    54
list($id,$motor_speed,$change) = post_register_manager($con,"motor_speed",$serial,"advance_settin","general*landing*based_on*",0,54,10);


//-------------------------------------------------CLEAR $POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    header("location: /GSM_RAVIS/main/ADVANCE/GENERAL/LANDING/motor_speed.php");
}
    ...
    * License: https://bootstrapmade.com/license/
    ...
    <SCRIPT>
        ...
        function refresh(){
            ...
            xhttp.open("GET", "motor_speed_ajax.php?"+str, true);
            xhttp.send();
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Motor Speed</li>
            </ol>
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><!--  Delay !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="0.1" value="<?php echo $motor_speed?>" name="motor_speed" id="motor_speed" type="number" class="form-control"  min="0" max="10">
                                            </div>
                                            <label class="col-sm-2 col-form-label text-danger ">M/S</label>
                                        </div>
                                    </li>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">سرعت کابین بر اساس متر بر ثانیه</div>
                                </div>
                            </div>
...
<script  src="motor_speed.js?v1"></script>
