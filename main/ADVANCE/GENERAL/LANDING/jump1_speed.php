...
for($i=1; $i<=$number_of_stop; $i++){
    list($id,$data,$change) = post_register_manager($con,"jump1speed*f$i",$serial,"advance_settin","general*landing*based_on*",1,$i*100+8);
}

//-------------------------------------------------CLEAR $POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    header("location: /GSM_RAVIS/main/ADVANCE/GENERAL/LANDING/jump1_speed.php");
}
...
/*        var on_load=0;
        ...
        function refresh(){
            ...
            xhttp.open("GET", "jump1_speed_ajax.php?"+str, true);
            xhttp.send();
                                            ...
                                            <table  class="table datatable text-center  ">
                                                ...
                                                for($i_floor=1;$i_floor<=$number_of_stop;$i_floor++ ){
                                                    ...
                                                    echo "<th class=\"table-active\" scope=\"row\">"."$temp"."</th>";
                                                        ...
                                                        echo "<select  id='jump1speed*f$i_floor' name='jump1speed*f$i_floor' class=\"form-select\" >";
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">سرعت حرکت کابین در مسیر طبقه</div>
                                </div>
                            </div>
...
<script  src="jump1_speed.js?v1"></script>
