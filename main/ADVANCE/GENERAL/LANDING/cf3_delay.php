...
//-------------------------------------------------CF3_DELAY	STNG 38
list($id,$cf3_delay,$change) = post_register_manager($con,"cf3_delay",$serial,"advance_settin","general*landing*based_on*",0,38,10);

//-------------------------------------------------CLEAR $POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    header("location: /GSM_RAVIS/main/ADVANCE/GENERAL/LANDING/cf3_delay.php");
}
    ...
    <SCRIPT>
       ...
       /* var on_load=0;
        ...
        function refresh(){
            ...
            xhttp.open("GET", "3fc_delay_ajax.php?"+str, true);
            xhttp.send();
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">CF3 Delay</li>
            </ol>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="card"  >
                    <div class="card-body ">
                        <h5 class="card-title">CF3 Delay</h5>
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><!--  Delay !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="0.1" value="<?php echo $cf3_delay;?>" name="cf3_delay" id="cf3_delay" type="number" class="form-control"  min="0" max="20">
                                            </div>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">تاخیر در دور اندازی بس از دیدن برچم مربوط به کلیه طبقات</div>
                                </div>
                            </div>
...
<script  src="cf3_delay.js?v1"></script>
