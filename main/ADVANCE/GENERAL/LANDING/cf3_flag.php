...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    header("location: /GSM_RAVIS/main/ADVANCE/GENERAL/LANDING/cf3_flag.php");
}
    ...
    <SCRIPT>
       ...
       /* var on_load=0;
        ...
        function refresh(){
            ...
            xhttp.open("GET", "cf3_flag_ajax.php?"+str, true);
            xhttp.send();
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">CF3 Flag</li>
            </ol>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="card"  >
                    <div class="card-body ">
                        <h5 class="card-title">CF3 Flag</h5>
                            ...
                            <div class="row mb-3 m-2" >
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><!--  Open Delay !-->
                                        <div class="row ">
                                            <label class="col-sm-4 col-form-label">CF3 Flag</label>
                                            <table  class="table datatable text-center  ">
                                                ...
                                                for($i_floor=1;$i_floor<=$number_of_stop;$i_floor++ ){
                                                    ...
                                                    echo "<select  id='jump1*f$i_floor' name='jump1*f$i_floor' class=\"form-select\" >";
                                                        list($id,$data,$ch) = only_read_data($con,$serial,"advance_settin","general*landing*based_on*jump1*f$i_floor");
                                                    show_list($List_jump1,$data);
                                                    echo "</select>" ;
                                                    echo "</td>";

                                                    echo "<td style='background-color: powderblue'>";
                                                    echo "<select  id='jumpn*f$i_floor' name='jumpn*f$i_floor' class=\"form-select\" >";
                                                    list($id,$data,$ch) = only_read_data($con,$serial,"advance_settin","general*landing*based_on*jumpn*f$i_floor");
                                                    show_list($List_jumpn,$data);
                                                    echo "</select>" ;
                                                    echo "</td>";
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">برچم سنسور دور انداز</div>
                                </div>
                            </div>
...
<script  src="cf3_flag.js?v1"></script>
