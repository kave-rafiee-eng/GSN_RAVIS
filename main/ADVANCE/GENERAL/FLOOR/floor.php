                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><!--  Park Floor !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="1" value="<?php echo $park_floor;?>" name="park_floor" type="number" class="form-control"  min="0" max="60">
                                            </div>
                                    ...
                                    <li class="list-group-item"><!--  Time To Park !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="1" value="<?php echo $time_to_park;?>" name="time_to_park" type="number" class="form-control"  min="0" max="200">
                                            </div>
                                    ...
                                    <li class="list-group-item"><!--  Fire Park !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="1" value="<?php echo $fire_park;?>" name="fire_park" type="number" class="form-control"  min="0" max="60">
                                            </div>
                                            <label class="col-sm-2 col-form-label text-danger "></label>
                                        </div>
                                    </li>
                                    ...
                                    <li class="list-group-item"><!--  Waiting Floor !-->
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-6">
                                                <input  step="1" value="<?php echo $waiting_floor;?>" name="waiting_floor" type="number" class="form-control"  min="0" max="250">
                                            </div>
