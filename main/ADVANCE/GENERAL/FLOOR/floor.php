...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    header("location: /GSM_RAVIS/main/ADVANCE/GENERAL/FLOOR/floor.php");
}
    ...
    <SCRIPT>
       ...
       /* var on_load=0;
        ...
        function refresh(){
            ...
            xhttp.open("GET", "floor_ajax.php?"+str, true);
            xhttp.send();
                        ...
                        <!-- <form method="post" action="" > -->
                            ...
                            <div class="row mb-3 m-2" >
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><!--  Park Floor !-->
                                        <div class="row ">
                                            <label class="col-sm-4 col-form-label">Park Floor</label>
                                            <div class="col-sm-6">
                                                <input  step="1" value="<?php echo $park_floor;?>" id="park_floor" name="park_floor" type="number" class="form-control"  min="0" max="60">
                                            </div>
                                            <label class="col-sm-2 col-form-label text-danger "></label>
                                        </div>
                                    </li>

                                    <li class="list-group-item"><!--  Time To Park !-->
                                        <div class="row ">
                                            <label class="col-sm-4 col-form-label">Time To Park</label>
                                            <div class="col-sm-6">
                                                <input  step="1" value="<?php echo $time_to_park;?>" id="time_to_park" name="time_to_park" type="number" class="form-control"  min="0" max="200">
                                            </div>
                                            <label class="col-sm-2 col-form-label text-danger ">min</label>
                                        </div>
                                    </li>

                                    <li class="list-group-item"><!--  Fire Park !-->
                                        <div class="row ">
                                            <label class="col-sm-4 col-form-label">Fire Park</label>
                                            <div class="col-sm-6">
                                                <input  step="1" value="<?php echo $fire_park;?>" id="fire_park" name="fire_park" type="number" class="form-control"  min="0" max="60">
                                            </div>
                                            <label class="col-sm-2 col-form-label text-danger "></label>
                                        </div>
                                    </li>

                                    <li class="list-group-item"><!--  Waiting Floor !-->
                                        <div class="row ">
                                            <label class="col-sm-4 col-form-label">Waiting Floor</label>
                                            <div class="col-sm-6">
                                                <input  step="1" value="<?php echo $waiting_floor;?>" id="waiting_floor" name="waiting_floor" type="number" class="form-control"  min="0" max="250">
                                            </div>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">تنظیم های مربوط به طبقات</div>
                                </div>
                            </div>
