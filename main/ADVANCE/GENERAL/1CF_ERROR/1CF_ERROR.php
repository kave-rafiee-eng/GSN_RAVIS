...
//-------------------------------------------------ENABLE_1CF_ERROR		STNG	8
list($id,$enable,$change) = post_register_manager($con,"enable",$serial,"advance_settin","general*1cf_error*",0,8);

//-------------------------------------------------ERROR_1CF_TIMEOUT 	STNG    39
list($id,$time_out,$change) = post_register_manager($con,"time_out",$serial,"advance_settin","general*1cf_error*",0,39);

//-------------------------------------------------CLEAR $POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    header("location: /GSM_RAVIS/main/ADVANCE/GENERAL/1CF_ERROR/1cf_error.php");
}
    ...
    * License: https://bootstrapmade.com/license/
    ...
    <SCRIPT>
        ...
        function refresh(){
            ...
            xhttp.open("GET", "1cf_error_ajax.php?"+str, true);
            xhttp.send();
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">1CF Error</li>
            </ol>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="card"  >
                    <div class="card-body ">
                        <h5 class="card-title">1CF Error</h5>
                        ...
                        <form method="post" action="" >
                            ...
                            <div class="row mb-3 m-2" >
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><!--  TIMR OUT !-->
                                        <div class="row ">
                                            <label class="col-sm-4 col-form-label">Time Out</label>
                                            <div class="col-sm-6">
                                                <input  step="1" value="<?php echo $time_out;?>" name="time_out" type="number" class="form-control"  min="0" max="20">
                                            </div>
