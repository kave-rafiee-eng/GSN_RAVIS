        ...
        <li class="nav-item">
            ...
            <ul id="General-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li class="nav-item" style="background: #dcdada">
                    <a style="background: #b5b2b2" class="nav-link collapsed" data-bs-target="#door-a" data-bs-toggle="collapse" href="#">
                        <i style="background: #dcdada" class="bi bi-chevron-down "></i><span>Door</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
